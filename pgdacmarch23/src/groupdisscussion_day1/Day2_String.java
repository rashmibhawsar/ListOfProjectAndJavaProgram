...
//************print duplicate characters from a string?***********************
	...
	void duplicates()
	{
		...
		{ int repatedcount=0;
			...
			System.out.println("maximum repeated occurring character '" +var1.charAt(i) +"' is:" +(++repatedcount));
		}
...
//How can a given string be reversed using recursion
	public String ReverseStringRecuression(int m, String str)
	{ String temp="";
...
public class Day2_String {
	...
	//r.duplicates();
	//r.anagrams();
	//System.out.println(r.ReverseStringRecuression(0, "rashmi"));
	//r.CheckString();
	//r.Checkvowels();
	//rr.palindrome();
	r.duplicates();
